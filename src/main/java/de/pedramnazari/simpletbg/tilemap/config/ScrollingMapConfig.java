...
public final class ScrollingMapConfig {
    ...
    public static final int[][] ITEMS = {
            ...
            {O, O, O, O, WEAPON_FIRE_STAFF.getType(), O, O, O, O, O, O, O, O, O, WEAPON_BOMB_PLACER.getType(), O, O, O, O, O},
            {O, O, O, O, O, O, O, O, O, O, O, O, O, O, O, O, O, O, O, O},
    ...
    public static final int[][] ENEMIES = {
            ...
            {O, O, O, O, O, O, O, O, O, O, O, ENEMY_TD.getType(), O, O, O, O, O, O, O, O},
            {O, O, O, O, O, O, ENEMY_TD.getType(), O, O, O, O, O, O, O, O, O, O, O, O, O},
