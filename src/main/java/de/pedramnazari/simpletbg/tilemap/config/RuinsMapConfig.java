...
public final class RuinsMapConfig {

    private RuinsMapConfig() {
    }

    public static final int HERO_START_ROW = 4;
    public static final int HERO_START_COLUMN = 4;
    ...
    public static final int[][] MAP = {
            ...
            {W, S, S, W, F, F, F, W, F, F, F, W, S, S, F, W},
            {W, F, F, F, F, W, F, F, F, W, F, F, F, W, F, W},
            {W, F, W, W, F, W, F, W, F, W, F, W, F, W, F, W},
            {W, F, W, F, F, F, F, F, F, F, F, F, F, F, F, W},
            {W, F, W, F, W, W, D, W, D, W, W, F, W, W, F, W},
            {W, F, F, F, W, F, F, F, F, F, W, F, F, F, F, W},
            {W, W, W, F, W, F, W, W, W, F, W, W, W, F, W, W},
            {W, F, F, F, F, F, F, F, W, F, F, F, F, F, F, W},
            {W, F, W, W, W, W, W, F, W, F, W, W, W, W, F, W},
            {W, F, F, F, F, F, F, F, F, F, F, F, F, F, X, W},
            {W, W, W, W, W, W, W, W, W, W, W, W, W, W, W, W},
    };

    public static final int[][] ITEMS = {
            {O, O, O, O, O, O, O, O, O, O, O, O, O, O, O, O},
            {O, O, O, O, HP, O, O, O, O, O, O, O, O, O, O, O},
            {O, O, O, O, O, O, SW, HP, O, O, O, O, O, O, O, O},
            {O, O, O, O, O, O, O, O, O, O, O, O, O, O, O, O},
            {O, O, O, O, O, RI, O, O, O, O, O, O, O, O, O, O},
            {O, O, O, O, O, O, O, O, O, O, O, BM, O, O, HP, O},
            {O, O, O, O, O, O, O, O, O, O, O, FS, O, O, O, O},
            {O, O, O, O, O, O, O, O, O, O, O, O, O, O, O, O},
            {O, O, O, O, O, O, O, O, O, O, O, O, O, O, O, O},
            {O, O, O, O, O, O, O, O, O, O, O, O, O, O, O, O},
            {O, O, O, O, LA, O, O, O, O, O, O, O, O, O, O, O},
            {O, O, O, O, O, O, O, O, O, O, O, O, O, O, O, O},
    };
    ...
    public static final int[][] ENEMIES = {
            {O, O, O, O, O, O, O, O, O, O, O, O, O, O, O, O},
            {O, O, O, O, O, O, O, O, O, O, O, O, O, O, O, O},
            {O, O, O, O, ELR, O, O, O, O, O, ELR, O, O, O, O, O},
            {O, O, O, O, O, O, O, O, O, O, O, O, O, O, O, O},
            {O, O, O, O, O, O, O, O, O, O, O, O, O, O, O, O},
            {O, O, O, O, O, O, O, O, O, O, O, O, O, O, O, O},
            {O, O, O, ETD, O, O, O, O, O, O, O, O, O, O, ETD, O},
            {O, O, O, O, O, O, O, O, O, O, O, O, O, O, O, O},
            {O, O, O, O, O, O, O, O, O, O, O, O, O, O, O, O},
            {O, O, O, O, O, O, O, E2D, O, O, O, O, O, O, O, O},
            {O, O, O, O, O, O, O, O, O, O, O, O, EFH, O, O, O},
            {O, O, O, O, O, O, O, O, O, O, O, O, O, O, O, O},
    };
}
