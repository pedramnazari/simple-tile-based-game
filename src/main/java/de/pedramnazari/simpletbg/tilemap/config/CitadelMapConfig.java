...
public final class CitadelMapConfig {
    ...
    public static final int[][] MAP = {
            ...
            {W, S, S, W, F, F, F, F, F, W, S, S, W},
            {W, S, F, F, F, W, W, W, F, F, F, S, W},
            {W, W, F, W, F, F, F, F, F, W, F, W, W},
            {W, F, F, F, D, W, F, W, D, F, F, F, W},
            {W, F, W, F, F, F, F, F, F, F, W, F, W},
            {W, F, F, F, W, F, P, P, W, F, X, F, W},
            {W, F, W, F, F, F, F, F, F, F, W, F, W},
            {W, F, F, F, D, W, F, W, D, F, F, F, W},
            {W, W, F, W, F, F, F, F, F, W, F, W, W},
            {W, S, F, F, F, W, W, W, F, F, F, S, W},
    ...
    public static final int[][] ITEMS = {
            ...
            {O, O, SW, O, O, O, O, O, O, LA, O, O, O},
            {O, O, O, O, O, O, O, O, O, O, O, O, O},
            {O, O, O, O, O, O, BM, O, O, O, O, O, O},
            {O, HP, O, O, O, O, O, O, O, O, O, O, O},
            {O, O, O, O, O, O, O, O, O, RI, O, O, O},
            {O, O, O, O, O, O, O, O, O, HP, O, O, O},
            {O, O, O, O, O, O, O, O, O, O, O, O, O},
            {O, O, O, O, O, O, O, O, O, O, O, O, O},
            {O, O, O, O, O, O, O, O, BM, O, O, O, O},
            {O, O, O, O, O, O, O, O, O, O, O, O, O},
            {O, O, O, O, O, O, O, O, O, O, O, O, O},
    };
    ...
    public static final int[][] ENEMIES = {
            {O, O, O, O, O, O, O, O, O, O, O, O, O},
            {O, O, O, O, O, O, O, O, O, O, O, O, O},
            {O, O, O, O, ELR, O, O, O, ELR, O, O, O, O},
            {O, O, O, O, O, O, O, O, O, O, O, O, O},
            {O, O, O, O, O, O, O, O, O, O, O, O, O},
            {O, O, O, ETD, O, O, O, O, O, ETD, O, O, O},
            {O, O, O, O, O, EFH, O, O, O, O, O, EFH, O},
            {O, O, O, O, O, O, O, O, O, O, O, O, O},
            {O, O, O, O, O, O, O, O, O, O, O, O, O},
            {O, O, O, O, ELR, O, O, O, ELR, O, O, O, O},
            {O, O, O, O, O, O, O, O, O, O, O, O, O},
            {O, O, O, O, O, O, E2D, O, O, O, O, O, O},
            {O, O, O, O, O, O, O, O, O, O, O, O, O},
    };
}
