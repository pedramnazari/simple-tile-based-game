...
public class IceWand extends Weapon implements IRangedWeapon {

    private final IProjectileFactory projectileFactory;

    public IceWand(int x,
                   int y,
                   IProjectileFactory projectileFactory) {
        super(x, y, "Ice Wand", "A wand that shoots freezing ice.", TileType.WEAPON_ICE_WAND.getType());
        this.projectileFactory = projectileFactory;
        setRange(5);
        setAttackingDamage(12);
    }
